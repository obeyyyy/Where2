      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12 w-full">
        ...
        >
          ...
          <div className="relative flex flex-col items-center mb-10">
            ...
            <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-[350px] h-[200px] md:w-[600px] md:h-[300px] bg-gradient-to-br from-[#FFE8C2] via-[#FFD580] to-[#FF8C00]/30 rounded-full blur-2xl opacity-60 -z-10" />
            <span className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-[#FFA500] to-[#FF8C00] shadow-xl mb-6">
  <img src="/Logo.svg" alt="Where2 Logo" className="w-full h-full object-contain drop-shadow-lg" />
</span>
            <h1 className="text-5xl md:text-6xl font-black mb-5 bg-gradient-to-r from-[#FF8C00] to-[#FFA500] bg-clip-text text-transparent drop-shadow-sm tracking-tight">
              Effortless Travel, Unbeatable Deals
            </h1>
            <p className="max-w-2xl text-xl md:text-2xl text-gray-700 mb-10 font-medium mx-auto">
              Discover your next adventure. Instantly bundle <span className="text-[#FF8C00] font-semibold">flights</span> & <span className="text-[#FFA500] font-semibold">hotels</span> for the best price—no hidden fees, no hassle. <br className="hidden md:inline" />
              <span className="inline-block mt-2 text-base md:text-lg text-gray-500">Plan smarter. Travel further. Experience more.</span>
            </p>
          </div>
  ...
  <div className="flex flex-col gap-16 w-full">
    ...
    > 
      ...
      <footer className="py-4 text-center text-gray-400 text-sm">
        &copy; {new Date().getFullYear()} Where2. All rights reserved.
      </footer>
    </div>
  );
}
